...
('Condão', NULL, 'Giordano Mochel Netto', 'Ficção Científica', NULL, 400, 'E:\L1\js\booksSongs\bookCovers\condao.jpg')

INSERT INTO musica (nome, artista, estilo, album, duracao, cover) VALUES 
('It Came from the TV', 'Secession Studios', 'Orquestra/Trilha Sonora', 'Vae Victis', 203, 'E:\L1\js\booksSongs\albumCovers\vaeVictis.jfif')
...
('Box HP Lovecraft', 'O Chamado de Cthulhu, A Cor que caiu do Céu, Sussurros na Escuridão e outros contos',
 'H.P. Lovecraft', 'Terror, Horror Cósmico', NULL, 448, 'E:\L1\js\booksSongs\bookCovers\box_hp_lovecraft_melhores_contos.jpg')

INSERT INTO musica (nome, artista, estilo, album, duracao, cover) VALUES 
('Lucifer's Waltz', 'Secession Studios', 'Orquestra', 'The Untold', 183, 'E:\L1\js\booksSongs\albumCovers\theUntold.jfif')
...
INSERT INTO livro (nome, livros_box, autor, genero, saga, paginas, cover) VALUES 
('Anardeus: No calor da destruição', NULL, 'Walter Tierno', 'Fantasia, Suspense', NULL, 184, 'E:\L1\js\booksSongs\bookCovers\anardeus_no_calor_da_destruicao.jpg')

INSERT INTO musica (nome, artista, estilo, album, duracao, cover) VALUES 
('Call Me Joker', 'Hildur Guõnadóttir', 'Neoclássica, Trilha Sonora', 'Joker (Original Motion Picture Soundtrack)', 288, 'E:\L1\js\booksSongs\albumCovers\jokerSoundtrack.jfif')
...
INSERT INTO livro (nome, livros_box, autor, genero, saga, paginas, cover) VALUES 
('As Cavernas de Aço: 1', NULL, 'Isaac Asimov', 'Ficção Científica, Crime', 'Ciclo dos Robôs', 304, 'E:\L1\js\booksSongs\bookCovers\as_cavernas_de_aco_1.jpg')

INSERT INTO musica (nome, artista, estilo, album, duracao, cover) VALUES 
('Night City Ride', 'Mark Holiday, Trendsetter, Ghost in The Shell', 'Synthwave', 'Synthwave and Futuresynth', 228, 'E:\L1\js\booksSongs\albumCovers\synthwave_futuresynth.jfif')
...
INSERT INTO livro (nome, livros_box, autor, genero, saga, paginas, cover) VALUES 
('Snow Crash', NULL, 'Neal Stephenson', 'Ficção Científica, Cyberpunk', NULL, 493, 'E:\L1\js\booksSongs\bookCovers\snowCrash.jpg')

INSERT INTO musica (nome, artista, estilo, album, duracao, cover) VALUES 
('Restless Destroyer', 'Dan Terminus', 'Synthwave, Darkwave', 'The Wrath of Code', 280, 'E:\L1\js\booksSongs\albumCovers\the_wrath_of_code.jpeg')
...
INSERT INTO livro (nome, livros_box, autor, genero, saga, paginas, cover) VALUES 
('Neuromancer', NULL, 'William Gibson', 'Ficção Científica, Cyberpunk', 'Trilogia do Sprawl', 320, 'E:\L1\js\booksSongs\bookCovers\neuromancer.jpeg')
